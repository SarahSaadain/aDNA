...
def prepare():
    ...
    duplicates_removed_folder = get_folder_path_species_processed_duplicates_removed(FOLDER_DMEL)
    ...
    input_pattern_path = os.path.join(duplicates_removed_folder, f"Dmel_*{FILE_ENDING_DUPLICATES_REMOVED_FASTQ_GZ}")
