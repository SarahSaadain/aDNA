...
def plot_reads_processing_result(species):
    ...
    generate_plots.call_r_script(R_SCRIPT_PLOT_COMPARE_SPECIES_READS_BEFORE_AFTER_PROCESSING, species_string, root_folder_path, output_folder_path)
...
def plot_depth_breadth_analysis(species: list):
    ...
    root_folder_path = PATH_ADNA_PROJECT
    output_folder_path = get_folder_path_results_plots()
    generate_plots.call_r_script(R_SCRIPT_PLOT_COMPARE_SPECIES_DEPTH_BREADTH, species_string, root_folder_path, output_folder_path)
...
def plot_endogenous_reads(species: list):
    ...
    root_folder_path = PATH_ADNA_PROJECT
    output_folder_path = get_folder_path_results_plots()
    generate_plots.call_r_script(R_SCRIPT_PLOT_COMPARE_SPECIES_ENDOGENOUS_READS, species_string, root_folder_path, output_folder_path)
