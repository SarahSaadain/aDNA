...
def run_ecmsd_per_species(species: str):
    common_adna.print_info(f"Processing species: {species}")
...
def all_species_run_ecmsd():
    common_adna.print_execution("Starting ECMSD analysis for all species on deduplicated FASTQ files.")
